...
\begin{figure}[ht]
	...
	\resizebox{\textwidth}{!}{
		\begin{ganttchart}[
			...
			\ganttbar{Implementasi Objek Angkot}{7}{10} \\
			\ganttbar{Implementasi Objek Tram}{10}{12} \\
			\ganttbar{Implementasi Objek Kendaraan}{10}{14} \\
            \ganttbar{Implementasi Lingkungan Baru}{14}{20} \\
		\end{ganttchart}
	}
