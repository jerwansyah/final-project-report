...
\begin{enumerate}
    ...
    \item Kendaraan dapat mengikuti kendali yang diberikan pengguna berupa
...
Validasi dilakukan dengan menjalankan simulasi \dots

% \verb|python3 manual_control.py --filter <nama_kendaraan>|
% \verb|python3 manual_control.py --filterv <nama_kendaraan> -n <jumlah_kendaraan> + -w 0|
% direktori \verb|/PythonAPI/examples/|
% go crazy?

% mengamati: vvv
    % nurut, dapat dikendalikan, expected behavior
    % newton law? kalo diem ya diem, kalo jalan ya jalan
    % ga tiba2 ilang atau mental atau joged2


\subsection{Hasil Validasi}

% TODO: add preamble again?
