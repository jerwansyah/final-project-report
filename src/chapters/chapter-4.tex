...
\begin{figure}[!h]
    \centering
    \subfloat[Kendali manual]{\includegraphics[width=0.47\textwidth]{resources/chapter-4/testing-tram-generate.png}}
    \hfill
    \subfloat[Kendali \textit{autopilot}]{\includegraphics[width=0.47\textwidth]{resources/chapter-4/testing-tram-manual.png}}
...
\begin{figure}[!h]
    \centering
    \subfloat[Kendali manual]{\includegraphics[width=0.47\textwidth]{resources/chapter-4/testing-angkot-generate.png}}
    \hfill
    \subfloat[Kendali \textit{autopilot}]{\includegraphics[width=0.47\textwidth]{resources/chapter-4/testing-angkot-manual.png}}
