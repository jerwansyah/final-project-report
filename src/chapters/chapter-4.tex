...
\begin{enumerate}
    ...
    \item Menjalankan perintah \verb|python3 manual_control.py --filter <nama_kendaraan>|
    dalam direktori \verb|/PythonAPI/examples/| untuk menguji kendali kendaraan
    secara manual untuk \textit{throttle}, \textit{brake}, dan \textit{steer}

    \item Menjalankan perintah \verb|python3 generate_traffic.py --filterv <nama_kendaraan> -n <jumlah_kendaraan> -w 0|
    dalam direktori \verb|/PythonAPI/examples/| untuk menguji kendali kendaraan
    secara \textit{autopilot}
