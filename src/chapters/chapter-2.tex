...
% reference of why carla build version is needed for advaced customization and
% development: https://carla.readthedocs.io/en/0.9.13/start_quickstart/
...
of bones} yang dapat dilihat pada Gambar \ref{fig:chains-of-bones}
\parencite{blender-armature-introduction, blender-armature-structure}. Setelah
...
sebuah objek atau objek model/\textit{mesh}
...
Penelitian oleh \textcite{rispro-trilaksono} merupakan penelitian mengenai
inovasi bidang otomotif yang mengembangkan sistem otonomi untuk trem menggunakan
...
tersebut \parencite{rispro-trilaksono}:
...
dengan persepsi atau visual \parencite{at-palmer}.
